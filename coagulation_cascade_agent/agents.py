...
class MixingStudyAnalyzerAgent:
    ...
    def audit(self, case: ClinicalCasePayload) -> List[AgentAlert]:
        ...
        if res:
            alerts.append(AgentAlert(
                ...
                sub_agent="MixingStudyAnalyzerAgent",
...
class FactorInhibitorClassifierAgent:
    ...
    def audit(self, case: ClinicalCasePayload) -> List[AgentAlert]:
        ...
        if res:
            alerts.append(AgentAlert(
                alert_id=str(uuid.uuid4())[:8],
                sub_agent="FactorInhibitorClassifierAgent",
...
class LupusAnticoagulantAssessorAgent:
    ...
    def audit(self, case: ClinicalCasePayload) -> List[AgentAlert]:
        ...
        if res:
            alerts.append(AgentAlert(
                alert_id=str(uuid.uuid4())[:8],
                sub_agent="LupusAnticoagulantAssessorAgent",
...
class CoagCoordinator:
    ...
    def __init__(self):
        ...
        self.agent_3 = LupusAnticoagulantAssessorAgent()
    ...
    def process_case(self, case: ClinicalCasePayload) -> Dict[str, Any]:
        ...
        dossier = {
            "system": "coagulation-cascade-agent",
            "domain": "Hematology / Coagulation",
